...
- `SyncWorkspaceSubscriptionService` currently treats missing provider state as a local deletion path; production billing lifecycle should preserve clear fallback/grace/cancelled truth instead of surprising state loss.
