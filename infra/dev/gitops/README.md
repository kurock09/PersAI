...
**Live acceptance (closed 2026-07-13):** historical foundation Slices 0.1 + 0.1b were accepted through bot pin `64be77d6`, required-reviewer approval, and resume workflow `29237479924`; proof pin `e5c249c3` / inventory `c9abf3e8…` remains historical foundation evidence. S1–S5 (`775e5781`, `5a2fd3bd`, `8d0520f4`, `3f498ef9`, `d23936d1`) and D4 repair `2f73d58c` are deployed. Final S6 parent acceptance closed ADR-146 on release `35024b39`, inventory `589c1c0e0561645dc08cf45a58313450f90ab5c460b939ca6d60692bd2b8126d`: `PUBLIC_MASTER_BLOCKED`, operator-owned SSH/custom TCP+UDP, restricted custom-port denial, redirect private-follow denial, private-answer DNS connect denial, unchanged browser/web-search, UI mode/audit/metrics, and cleanup all passed. The parent executed equivalent direct probes individually rather than one exact helper `--execute`; timed public-to-private rebinding remains optional hardening. The approximately 90-second shell timeout is a non-egress product residual. Observability/runbook: `infra/dev/gke/ADR146-OBSERVABILITY.md`.
