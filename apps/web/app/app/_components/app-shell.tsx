              ...
              <Suspense>
                ...
                >
                  ...
                  <div
                    ...
                    className={cn(
                      "absolute top-1/2 right-0 z-20 flex -translate-y-1/2 translate-x-2.5 cursor-col-resize flex-col items-center gap-0.5 rounded-full px-0.5 py-2",
                      "touch-none select-none",
                      sidebarResizeActive ? "opacity-70" : "opacity-45 hover:opacity-70"
                    )}
                  ...
                  >
                    <span className="h-1 w-1 rounded-full bg-text-subtle/45" aria-hidden="true" />
                    <span className="h-1 w-1 rounded-full bg-text-subtle/45" aria-hidden="true" />
                    <span className="h-1 w-1 rounded-full bg-text-subtle/45" aria-hidden="true" />
                    <span className="h-1 w-1 rounded-full bg-text-subtle/45" aria-hidden="true" />
                  </div>
