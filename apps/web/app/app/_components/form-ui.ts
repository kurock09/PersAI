...
export function userFieldClassName(className?: string): string {
  return cn(
    // Mobile ≥16px avoids iOS focus-zoom; desktop keeps the denser 14px control.
    "w-full rounded-2xl border border-border/80 bg-background px-4 py-3 text-base text-text shadow-[inset_0_1px_0_rgba(255,255,255,0.28),0_1px_2px_rgba(0,0,0,0.03)] outline-none transition-[border-color,background-color,box-shadow] placeholder:text-text-subtle hover:border-border hover:bg-background focus:border-accent/50 focus:bg-background focus:shadow-[inset_0_1px_0_rgba(255,255,255,0.34),0_0_0_3px_rgba(191,148,84,0.12)] md:text-sm dark:border-white/14 dark:bg-surface-raised/52 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_1px_2px_rgba(0,0,0,0.22)] dark:hover:border-white/20 dark:hover:bg-surface-raised/68 dark:focus:border-accent/45 dark:focus:bg-surface-raised/60 dark:focus:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_0_0_3px_rgba(191,148,84,0.16)]",
    className
  );
}
