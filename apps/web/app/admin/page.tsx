    ...
    try {
      ...
      setStats([
        ...
        },
        {
          ...
          sub:
            ops.incidentSignals.length === 0
              ? "All clear"
              : `${ops.incidentSignals.filter((s) => s.severity === "high").length} high`,
          color: ops.incidentSignals.some((s) => s.severity === "high")
            ? "text-destructive"
            : "text-success"
        },
        {
        ...
        },
        {
          ...
          color:
            biz.quotaPressure.pressureLevel === "low"
              ? "text-success"
              : biz.quotaPressure.pressureLevel === "high"
                ? "text-destructive"
                : "text-warning"
        }
      ]);
    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          <h2 className="mt-8 mb-3 text-xs font-semibold uppercase tracking-wider text-text-subtle">
            Quick Access
          </h2>
