-- User support tickets tables + default user_support notification policy.
...
SELECT
    gen_random_uuid(),
    'user_support'::"NotificationSource",
    true,
    ...
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
    SELECT 1 FROM "notification_policies" WHERE "source" = 'user_support'::"NotificationSource"
);
