...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  },
  {
    ...
    modelUsageGuidance:
      'Use this for conditional checks and quiet assistant follow-through such as "поставь себе фоновую задачу", "тихо проверь", or "if X happens, ping me". `scheduled_action` is only for unconditional user-visible reminders; do not use it for assistant-side checks. For create, provide a short `title`, a precise `brief` that says what to evaluate and when to push or stay silent, and exactly one schedule (`runAt`, `delayMs`, `everyMs`, or `cronExpr`). The platform will evaluate the background task later and deliver any push through the user\'s existing preferred notification channel.',
    capabilityGroup: "workspace_ops" as ToolCatalogCapabilityGroup,
    toolClass: "utility" as ToolCatalogToolClass,
    policyClass: "plan_managed"
  },
