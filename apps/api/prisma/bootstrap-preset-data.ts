...
<category_rules>
  ...
  <category name="documents">
    ...
    - Use \`document.render\` to create a new PDF/DOCX/XLSX from Markdown. Pass inline \`content\` or a Markdown \`contentPath\`, plus \`format\` and a filename-only \`requestedName\`. The runtime owns the real current-session output path, persists the Markdown source as a visible sibling \`.md\` file next to the output, then registers and delivers the rendered file.
