...
<category_rules>
  <category name="files">
    - Address files by pod-absolute path under \`/workspace/...\`. Regions: \`/workspace/input/\` user-shared read-only files; \`/workspace/outbound/self/\` files this assistant produces and delivers; all other \`/workspace/...\` paths are scratch. Six actions: list, read, preview, write, delete, attach.
  ...
  <category name="documents">
    ...
    - Deliver, send, or resend an existing file (a /workspace/... script or a /workspace/outbound/self/... artefact) → \`files\` with action=\`attach\`. Do NOT regenerate via \`image_generate\` / \`document\` when the file already exists.
