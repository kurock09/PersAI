...
export function buildAdminToolCredentialsState(params: {
  ...
  const DISPLAY_NAMES: Record<ToolCredentialKey, string> = {
    ...
    tool_video_generate_kling: "Video Generation API Key (Kling)",
  ...
  return {
    ...
    notes: [
      ...
      "Runway and Kling video provider credentials are stored separately for Admin-managed video catalog setup and later video execution slices.",
