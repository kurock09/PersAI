...
export const TOOL_CREDENTIAL_IDS = {
  ...
  tool_live_voice_custom_llm_ingress: "tool/live_voice/custom_llm_ingress/secret",
  tool_live_voice_relay_ticket: "tool/live_voice/relay_ticket/secret",
...
export const TOOL_CODE_BY_CREDENTIAL_KEY: Record<ToolCredentialKey, string> = {
  ...
  tool_live_voice_custom_llm_ingress: "live_voice",
  tool_live_voice_relay_ticket: "live_voice",
  tool_tts_yandex: "tts",
  tool_tts_openai: "tts",
...
export function buildAdminToolCredentialsState(params: {
  ...
  const DISPLAY_NAMES: Record<ToolCredentialKey, string> = {
    ...
    tool_image_generate: "Image Generation / Edit / OpenAI Video API Key",
    ...
    tool_live_voice_custom_llm_ingress: "Live Voice Custom LLM Ingress Secret",
    tool_live_voice_relay_ticket: "Live Voice Relay Ticket Secret",
