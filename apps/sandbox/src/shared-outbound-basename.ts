/**
 * ADR-126 D8 / ADR-131 Block 1 — macOS-style numeric suffix collision for
 * shared-outbound basenames.
 * `report.pdf` → `report (1).pdf` → `report (2).pdf`.
 *
 * If the requested basename already ends with ` (N)`, keep that exact name
 * when it is free, otherwise continue from `N + 1`.
 */
