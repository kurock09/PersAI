...
export interface AdminPlanInputBase {
  ...
  /** When `true`, async `image_generate` / `image_edit` completion framing may attach produced (and for edit, source) image bytes for one multimodal review turn before delivery. */
